...
?>
<div class="article-card with-shadow related-card"><div class="article-card__img aspect-img"><figure><?= $featuredImage ?></figure></div><div class="article-card__info"><div class="article-card__title dynamic-title"><h2 class="text-overflow-lines-3"><a href="<?= $permalink ?>" target="_blank"><?= $title ?></a></h2></div><div class="article-card__excerpt text-overflow-lines-3"><p><?= $excerpt ?></p></div></div><div class="article-card__footer"><div class="custom-read-more"><a class="read-more" href="<?= $permalink ?>" target="_blank">Read more</a></div></div></div>
<?php endforeach; ?>
<?php endif; ?>
<?php
if ($query_count > 0) :
